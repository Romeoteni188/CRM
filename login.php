...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          <!-- <h2 text-align: center>Bievenidos a nuestro CRMCODECRANIUM</h2> -->
          <p>
            Da la bienvenida a tus sueños, pues gracias a ellos pasará grandes cosas.</p>
            <br>
        ...
        <div class="col-md-5 "> <br>
		 ...
		 <form id="login-form" class="login-form" action="dashboard.php" method="post">
		 <div class="row">
		 <div class="form-group col-md-10">
          ...
          <div class="control-group  col-md-10">
            <div class="checkbox checkbox check-success"> <a href="forgot-password.php">Has olvidado tu contraseña! </a>&nbsp;&nbsp;
         </div>
          </div>
          </div>
          <div class="row">
            <div class="col-md-10">
              <button class="btn btn-primary btn-cons pull-right" name="login" type="submit">Acceso</button>
            </div>
          </div>
		  </form>
        </div>
