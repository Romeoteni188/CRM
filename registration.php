...
<div class="container">
  <div class="row login-container column-seperation">  
        ...
        <div class="col-md-6 "> <br>
		 <form  id="signup" name="signup" class="login-form" action="login.php" onsubmit="return checkpass();" method="post">
		 <div class="row">
         ...
         <div class="row">
            <div class="col-md-10">
              <input   class="btn btn-primary btn-cons pull-right" name="submit" value="Enviar" type="submit" href='login.php' />
            </div>
          </div>
		  </form>
        </div>
