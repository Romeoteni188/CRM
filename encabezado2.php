...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-success fixed-top">
        <a class="navbar-brand" href="login.php">CRM 2024</a>
        ...
        <div class="collapse navbar-collapse" id="miNavbar">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="login.php"> <a class="navbar-brand" href="login.php">Bienvenidos a nuestro CRMCODECRANIUM</a></a>
                </li>
